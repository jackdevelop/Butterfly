    ...
    int       nCmdShow)
{
    ...
    return ButterflyPlayer::createAndRun();
}

int ButterflyPlayer::createAndRun(void)
{
    ButterflyPlayer *host = ButterflyPlayer::sharedInstance();
    int ret = host->run();
    ButterflyPlayer::purgeSharedInstance();
    return ret;
}

ButterflyPlayer *ButterflyPlayer::s_sharedInstance = NULL;

ButterflyPlayer *ButterflyPlayer::sharedInstance(void)
{
    if (!s_sharedInstance)
    {
        s_sharedInstance = new ButterflyPlayer();
    }
    return s_sharedInstance;
}

void ButterflyPlayer::purgeSharedInstance(void)
{
    if (s_sharedInstance)
    {
...
ButterflyPlayer::ButterflyPlayer(void)
: m_app(NULL)
, m_hwnd(NULL)
, m_exit(TRUE)
...
int ButterflyPlayer::run(void)
{
    ...
    do
    {
        ...
        SetWindowTextA(m_hwnd, "butterfly-player");
...
void ButterflyPlayer::loadProjectConfig(void)
{
    vector<string> args;
...
void ButterflyPlayer::createViewMenu(void)
{
...
void ButterflyPlayer::updateMenu(void)
{
    HMENU menu = GetMenu(m_hwnd);
    HMENU viewMenu = GetSubMenu(menu, 1);
...
void ButterflyPlayer::updateWindowTitle(void)
{
}

void ButterflyPlayer::relaunch(void)
{
...
void ButterflyPlayer::writeDebugLog(const char *log)
{
...
// menu callback
void ButterflyPlayer::onFileOpenProject(void)
{
...
void ButterflyPlayer::onFileCreateProjectShortcut(void)
{
    ...
    if (SUCCEEDED(hres))
    {
        ...
        psl->SetDescription(L"ButterflyPlayer");
...
void ButterflyPlayer::onFileProjectConfig(void)
{
...
void ButterflyPlayer::onFileRelaunch(void)
{
    relaunch();
}

void ButterflyPlayer::onFileExit(void)
{
    DestroyWindow(m_hwnd);
}

void ButterflyPlayer::onViewChangeFrameSize(int viewMenuID)
{
...
void ButterflyPlayer::onViewChangeOrientation(int viewMenuID)
{
    bool isLandscape = m_project.isLandscapeFrame();
...
void ButterflyPlayer::onViewChangeZoom(int scaleMode)
{
    float scale = 1.0f;
...
void ButterflyPlayer::onHelpAbout(void)
{
    DialogBox(GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_ABOUTBOX), m_hwnd, AboutDialogCallback);
}

// windows callback
LRESULT ButterflyPlayer::WindowProc(UINT message, WPARAM wParam, LPARAM lParam, BOOL* pProcessed)
{
    int wmId, wmEvent;
    ButterflyPlayer *host = ButterflyPlayer::sharedInstance();
...
INT_PTR CALLBACK ButterflyPlayer::AboutDialogCallback(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
